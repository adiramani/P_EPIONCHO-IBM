...
project_root = "/Users/adi/Documents/Github Repos/P_EPIONCHO-IBM/examples/"

if project_root and project_root not in sys.path:
    sys.path.insert(0, project_root)

# You can edit the inputs to this function to set more parameters dynamically
def get_parameters(iter, abr=1641, kE=0.3, psf=0.5, x0=0, x1=1):
...
def run_simulations(
    ...
    endgame_structure = get_parameters(i, abr=abr, kE=kE, psf=psf, x0=x0, x1=x1)
...
def run_model_for_fits(cores, num_iters, abr, kE, psf, x0, x1, verbose=False):
