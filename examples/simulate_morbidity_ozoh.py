...
if __name__ == "__main__":
    ...
    write_data_to_csv(
        data,
        "test_outputs/python_model_output/ozoh_data/morbidity_output_" + mda_to_site[mda_index] + "_abr_" + str(abr_val) + "_rho_" + str(rho_values[mda_index]) + "_nevertreated_" + str(never_ever_treated_values[mda_index]) + ".csv"
    )
    write_data_to_csv(
        age_data,
        "test_outputs/python_model_output/ozoh_data/morbidity_output_age-grouped_" + mda_to_site[mda_index] + "_abr_" + str(abr_val) + "_rho_" + str(rho_values[mda_index]) + "_nevertreated_" + str(never_ever_treated_values[mda_index]) + ".csv"
    )
    write_data_to_csv(
        age_data_2,
        "test_outputs/python_model_output/ozoh_data/morbidity_output_age-grouped_2_" + mda_to_site[mda_index] + "_abr_" + str(abr_val) + "_rho_" + str(rho_values[mda_index]) + "_nevertreated_" + str(never_ever_treated_values[mda_index]) + ".csv"
    )
